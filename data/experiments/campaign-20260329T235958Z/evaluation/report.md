...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| cpu_hog_like | paper_fidelity_research_anchor | 8 | 0.750 | 0.000 | 0.750 | 0.000 | 0.000 | 0.750 | 0.750 | 0.750 [0.429, 1.071] | 2.54 [0.97, 4.11] |
| mem_leak | paper_fidelity_research_anchor | 8 | 0.925 | 0.000 | 0.925 | 0.000 | 0.000 | 1.000 | 0.925 | 0.958 [0.918, 0.998] | 4.89 [3.69, 6.09] |
| net_hog_like_latency | paper_fidelity_research_anchor | 8 | 0.125 | 0.000 | 0.125 | 0.000 | 0.000 | 0.125 | 0.125 | 0.125 [-0.120, 0.370] | 0.41 [-0.39, 1.21] |

## Paper-Faithful Findings

- `mem_leak` / `paper_fidelity_research_anchor`: F1=0.958, precision=1.000, recall=0.925, paper_AT=0.925, paper_AF=0.000, FPR_alarm=0.000, faithfulness=paper-faithful-with-proxy
- `cpu_hog_like` / `paper_fidelity_research_anchor`: F1=0.750, precision=0.750, recall=0.750, paper_AT=0.750, paper_AF=0.000, FPR_alarm=0.000, faithfulness=paper-faithful-with-proxy
- `net_hog_like_latency` / `paper_fidelity_research_anchor`: F1=0.125, precision=0.125, recall=0.125, paper_AT=0.125, paper_AF=0.000, FPR_alarm=0.000, faithfulness=paper-faithful-with-proxy
...
- Low-F1 case `net_hog_like_latency` / `paper_fidelity_research_anchor`: F1=0.125, precision=0.125, recall=0.125, paper_AF=0.000, FPR_alarm=0.000

## Stratified Rollups

| Group Type | Group Name | n | Mean F1 | Mean Precision | Mean Recall | Mean TPR | Mean paper_AF | Mean FPR (alarm) |
|---|---|---:|---:|---:|---:|---:|---:|---:|
| ablation_block | decision | 24 | 0.611 | 0.625 | 0.600 | 0.600 | 0.000 | 0.000 |
| fault_family | paper_aligned | 24 | 0.611 | 0.625 | 0.600 | 0.600 | 0.000 | 0.000 |
| study_scope | paper_faithful | 24 | 0.611 | 0.625 | 0.600 | 0.600 | 0.000 | 0.000 |
| variant_fault_family | paper_fidelity_research_anchor|paper_aligned | 24 | 0.611 | 0.625 | 0.600 | 0.600 | 0.000 | 0.000 |
...
|---|---|---:|---:|---:|---:|
| paper_fidelity_research_anchor | cpu_hog_like | 8 | 0.9271 | 5.9785 | 25.7995 |
| paper_fidelity_research_anchor | mem_leak | 8 | 0.9208 | 238.6661 | 33323.5632 |
| paper_fidelity_research_anchor | net_hog_like_latency | 8 | 0.9333 | 1.3145 | 0.1890 |
