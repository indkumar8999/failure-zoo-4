...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| mem_leak | minimal_ubl | 1 | 1.000 | 0.684 | 0.316 | 1.000 | 0.480 [0.480, 0.480] | 6.02 [6.02, 6.02] |
...
- `mem_leak` / `minimal_ubl`: F1=0.480, lead=6.02s, ablation_block=decision
...
- Low-F1 case `mem_leak` / `minimal_ubl`: F1=0.480, TPR=1.000, FPR=0.684

## Stratified Rollups

| Group Type | Group Name | n | Mean F1 | Mean TPR | Mean FPR |
|---|---|---:|---:|---:|---:|
| ablation_block | decision | 1 | 0.480 | 1.000 | 0.684 |
| fault_family | paper_aligned | 1 | 0.480 | 1.000 | 0.684 |
| study_scope | extended | 1 | 0.480 | 1.000 | 0.684 |
| variant_fault_family | minimal_ubl|paper_aligned | 1 | 0.480 | 1.000 | 0.684 |
...
|---|---|---:|---:|---:|---:|
| minimal_ubl | mem_leak | 1 | 1.0000 | 25.7629 | 50352.1969 |
