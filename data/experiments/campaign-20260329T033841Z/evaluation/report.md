...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| mem_leak | ubl_roc_sweep | 5 | 1.000 | 0.000 | 1.000 | 0.000 | 0.000 | 1.000 | 1.000 | 1.000 [1.000, 1.000] | 6.45 [4.48, 8.41] |
...
- `mem_leak` / `ubl_roc_sweep`: F1=1.000, precision=1.000, recall=1.000, lead=6.45s, ablation_block=decision
...
- Low-F1 case `mem_leak` / `ubl_roc_sweep`: F1=1.000, precision=1.000, recall=1.000, paper_AF=0.000, FPR_alarm=0.000

## Stratified Rollups

| Group Type | Group Name | n | Mean F1 | Mean Precision | Mean Recall | Mean TPR | Mean paper_AF | Mean FPR (alarm) |
|---|---|---:|---:|---:|---:|---:|---:|---:|
| ablation_block | decision | 5 | 1.000 | 1.000 | 1.000 | 1.000 | 0.000 | 0.000 |
| fault_family | paper_aligned | 5 | 1.000 | 1.000 | 1.000 | 1.000 | 0.000 | 0.000 |
| study_scope | extended | 5 | 1.000 | 1.000 | 1.000 | 1.000 | 0.000 | 0.000 |
| variant_fault_family | ubl_roc_sweep|paper_aligned | 5 | 1.000 | 1.000 | 1.000 | 1.000 | 0.000 | 0.000 |
...
|---|---|---:|---:|---:|---:|
| ubl_roc_sweep | mem_leak | 5 | 0.8667 | 30.1073 | 54964.2344 |
